...
// ── FALLBACK outside component to avoid useCallback dependency warning ────────
const FALLBACK = [
        ...
        <div style={{ background:"#111827", border:"1px solid #1e2d45", borderRadius:16, overflow:"hidden" }}>
          <table style={{ width:"100%", borderCollapse:"collapse" }}>
              ...
              <tr style={{ background:"#0d1424" }}>
                {["Student","Career Path","Skills","Profile","Applied","Action"].map((h,i) => (
                  <th key={i} style={{
                    ...
                    letterSpacing:"0.05em", borderBottom:"1px solid #1e2d45",
                  }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {students.map((s, i) => (
                <tr key={s._id||i}
                  style={{ borderBottom:"1px solid #1e2d4533", transition:"background .15s" }}
                ...
                >
                  ...
                  <td style={{ padding:"14px 16px" }}>
                    {s.careerPath ? (
                      <span style={{
                        ...
                        background:(pathColor[s.careerPath]||"#94a3b8")+"22",
                        color: pathColor[s.careerPath]||"#94a3b8",
                      }}>
                  ...
                  {/* Applied */}
                  <td style={{ padding:"14px 16px", color:"#a78bfa", fontWeight:600, fontSize:"0.9rem" }}>
                  ...
                  <td style={{ padding:"14px 16px" }}>
                    <div style={{ display:"flex", gap:6 }}>
                      <button onClick={() => setSelected(s)} style={{
                        padding:"5px 12px", borderRadius:6, border:"1px solid #1e2d45",
                      ...
                      <button onClick={() => remove(s._id)} style={{
                        ...
                        background:"#ef444411", color:"#ef4444", cursor:"pointer", fontSize:"0.75rem",
                      }}>Remove</button>
                    </div>
                  </td>
                </tr>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button onClick={() => setSelected(null)} style={{
              marginTop:"1.5rem", width:"100%", padding:"11px", borderRadius:10,
              border:"1px solid #1e2d45", background:"transparent", color:"#94a3b8",
